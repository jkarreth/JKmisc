theme_jk <- function(base_size = 11, base_family = "Helvetica")
{
    theme_bw(base_size = base_size, base_family = base_family) %+replace%
        theme(
            strip.background = element_rect(fill = NA, color = "black", size = 0),
            ...
            panel.grid.major = element_line(colour = "grey90", size = 0.4, linetype = 3), 
            panel.grid.minor = element_line(colour = "grey85", size = 0.2, linetype = 3),
